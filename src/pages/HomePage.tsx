...
import { MessageContainer, MsgInfo, MsgPosition, MsgSender } from "../Components/MessageBox";
...
interface homePageProps {
  commands: (arg0: (newMessage: newMessage) => number, arg1: (text: string, index: number) => void) => void;
}
...
export const homePage: Component<homePageProps> = (props) => {
  ...
  props.commands(appendMessage, updateMessage);
