...
import { MsgInfo } from "./Components/MessageBox";
import { ChatConfig, sendChatMessage } from "./Ai/ChatService";
  ...
  const content: PageWrapper[] = [
    {
      ...
      content: (
        <Dynamic
          component={homePage}
          commands={(append, update) => {appendMessage = append; updateMessage = update;}}
        />
      ),
    },
    {
